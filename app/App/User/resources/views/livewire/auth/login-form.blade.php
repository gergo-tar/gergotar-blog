        ...
        <form>
            <div class="row">
                ...
                <div class="text-center col-md-12">
                    <button class="text-white btn btn-success" wire:click.prevent="registerStore">Register</button>
                </div>
                <div class="col-md-12">
    ...
    @else
        <form>
            <div class="row">
                ...
                <div class="text-center col-md-12">
                    <button class="text-white btn btn-success" wire:click.prevent="login">Login</button>
                </div>
                <div class="col-md-12">
