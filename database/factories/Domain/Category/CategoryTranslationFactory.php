...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\Domain\Category\Models\CategoryTranslation>
 */
class CategoryTranslationFactory extends AbstractTranslationFactory
{
    /**
